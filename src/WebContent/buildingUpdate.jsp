...
<head>
	...
	<meta http-equiv="description" content="BuildingUpdate">
</head>
<body>
	<s:form name="buildingUpdateForm" action="BuildindUpdateAction">
	...
	<s:text name="UPDATESUCCESS">UPDATESUCCESS</s:text>
	<s:actionerror/>
</body>
</html>