	...
	<div class="container">
			...
			<s:actionerror/>
      		...
      		<s:form name="classroomForm" action="ClassroomDeleteAction">
        		...
        		<button type="submit" class="btn btn-primary" onclick="clsdelmsg();">删除</button>
        		<a href="#clsimport" data-toggle="modal" class="btn btn-primary">导入</a>
        		<button type="submit" class="btn btn-primary" onclick="clsexpmsg();">导出</button>
        		</s:if>
        		<s:else>
        			<a href="#clsnew" data-toggle="modal" class="btn btn-primary">新增</a>
        			<a href="#clsimport" data-toggle="modal" class="btn btn-primary">导入</a>
      		...
      		<div class="modal hide" id="clsimport">
    		<s:form name="classroomImportForm" action="classroomImport" enctype="multipart/form-data">
        	...
        	<div class="modal hide" id="clsupdate">
    			<s:form name="classroomForm" action="classroomUpdate">
      			...
      			<s:iterator value="classroomlst" status="classroom">
        			...
        			<input type="hidden" value='<s:property value="clsId" />' name="clsid" style="height:30px" onclick="this.value='';focus()">
        			<select name="compus" id="compus">
